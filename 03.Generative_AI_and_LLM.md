...
Generative AI:
Input → Model → New Content Creation
"Draw a cat" → 🐱 (generates image)
"Write about cats" → (generates text)
```
...
✗ Vanishing gradients
✗ Hard to parallelize
✗ Limited context (100s of tokens)
```
...
- "France": 0.92 ← Highest probability
- "Europe": 0.03
- "fashion": 0.02
- ...
...
Step 4: Predict "a" → "Once upon a time there was a"
Step 5: Predict "dragon" → "Once upon a time there was a dragon"
...
...
"bank" attends to:
- "steep" (high attention) → river bank
- "climb" (high attention) → not financial
...
"bank" attends to:
- "closed" (high attention) → financial institution
- "ATM" (high attention) → financial
...
|-------|------|---------|------|--------------|
| **GPT-4** | ~1T | 8K-32K | ✗ | Reasoning, multimodal |
| **Claude 2** | Unknown | 100K | ✗ | Long context, safety |
| **Llama 2 70B** | 70B | 4K | ✓ | Open, efficient |
| **PaLM 2** | Unknown | 8K | ✗ | Multilingual |
...
He buys 2 cans with 3 balls each, so 2 × 3 = 6 balls.
Total: 5 + 6 = 11 balls."
...
- **[02: AI/ML Fundamentals](02.AI_ML_Fundamentals.md)** - Neural network basics underlying LLMs
- **[04: Transformer Architecture](04.Transformer_Architecture.md)** - Detailed transformer mechanics
- **[05: Model Selection](05.Model_Selection.md)** - Choosing the right LLM
- **[06: Model Customization](06.Model_Customization.md)** - RAG and prompt engineering
- **[07: Model Training](07.Model_Training.md)** - Fine-tuning techniques
- **[08: NVIDIA Ecosystem](08.NVIDIA_Ecosystem.md)** - NeMo for LLM development
- **[09: Ethical AI](09.Ethical_AI.md)** - Safety and alignment
