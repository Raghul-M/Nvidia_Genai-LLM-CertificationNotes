...
- **[O2: AI/ML Fundamentals](O2.AI_ML_Fundamentals.md)** - Neural network basics
- **[O3: Generative AI and LLMs](O3.Generative_AI_and_LLM.md)** - LLMs built on transformers
- **[O5: Model Selection](O5.Model_Selection.md)** - Different transformer variants
- **[O6: Model Customization](O6.Model_Customization.md)** - Using transformers effectively
- **[O7: Model Training](O7.Model_Training.md)** - Training transformer models
- **[O8: NVIDIA Ecosystem](O8.NVIDIA_Ecosystem.md)** - Optimizing transformers on GPUs

---

**Next Module**: [O5: Model Selection and Embeddings](O5.Model_Selection.md)
